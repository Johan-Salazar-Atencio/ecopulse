...
// URL del backend. En produccion (Vercel) apunta al backend Spring Boot en Render.
// Ajusta API_BASE a la URL de tu backend Render, p.ej. https://ecopulse-backend.onrender.com
const API_BASE = (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')
    ? '' // Servido por el propio Spring Boot en local
    : 'https://ecopulse-backend.onrender.com'; // Backend desplegado en Render
